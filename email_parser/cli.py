...
from email_parser.processor import EmailParser, ProcessingConfig
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    process_parser.add_argument("--max-attachment-size", type=int, default=10_000_000, 
    ...
    batch_parser.add_argument("--max-attachment-size", type=int, default=10_000_000, 
                             help="Maximum attachment size in bytes")
