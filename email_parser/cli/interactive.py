...
from email_parser.config.profiles import ProfileManager, ProcessingProfile
...
class InteractiveCLI:
    ...
    def _select_profile(self, scan_result: Optional[ScanResult]) -> ProcessingProfile:
        ...
        for i, profile in enumerate(profiles, 1):
            marker = " (recommended)" if profile.name == self._get_recommended_profile(scan_result) else ""
