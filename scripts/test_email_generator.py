...
TEST_IMAGE_PATH = PROJECT_ROOT / "tests" / "test_image.jpg"
...
def create_complex_email():
    ...
    # Add inline image - use the test image from tests directory
    if TEST_IMAGE_PATH.exists():
        with open(TEST_IMAGE_PATH, 'rb') as f:
            image = MIMEImage(f.read())
    else:
        # Create test image if it doesn't exist
        print(f"Test image not found at {TEST_IMAGE_PATH}, creating a minimal JPEG...")
