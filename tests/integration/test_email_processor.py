...
# tests/integration/test_email_processor.py
    def setUp(self):
        ...
        self.test_output_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "temp_test_output")
    ...
    def test_process_email_file_path(self):
    ...
    def test_process_email_batch(self):
        ...
        batch_result = self.processor.process_email_batch(email_paths, email_ids)
